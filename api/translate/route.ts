  ...
  try {
    ...
    if (body.type === 'voice') {
      const whisperRes = await axios.post(
        ...
        { file: \\data:audio/webm;base64,\\\\, model: process.env.OPENROUTER_WHISPER_MODEL },
      ...
      return NextResponse.json({ original: originalText, translated, audioUrl: \\data:audio/mp3;base64,\\\\ })
    }
