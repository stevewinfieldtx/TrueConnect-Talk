      ...
      {!joined ? (
        <div style={{ display: 'flex', gap: 16, justifyContent: 'center' }}>
          ...
          <button 
            ...
            style={{ backgroundColor: '#2563eb', padding: '12px 24px', borderRadius: 4, color: 'white', border: 'none', cursor: 'pointer' }}
          >
            Join
          </button>
        </div>
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <input 
              ...
              style={{ flex: 1, backgroundColor: '#374151', padding: 12, borderRadius: 4, color: 'white', border: 'none' }} 
            />
            <button 
              onClick={() => { setMessages([...messages, myText]); setMyText('') }}
              style={{ backgroundColor: '#16a34a', padding: '12px 24px', borderRadius: 4, color: 'white', border: 'none', cursor: 'pointer' }}
            >
              Send
            </button>
          </div>
